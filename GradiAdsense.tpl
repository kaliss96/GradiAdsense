...
<a class="banner" href="{$gadsense_link}">
  {if isset($gadsense_img)}
    ...
    <img src="{$gadsense_img}" alt="{$gadsense_desc}" title="{$gadsense_desc}"/>
	    <a style="text-decoration: none; padding: 10px;  font-weight: 600; font-size: 20px; color: #ffffff; background-color: #1883ba; border-radius: 6px; border: 2px solid #0016b0;" href="{$gadsense_link_cta}">{$gadsense_cta}</a>
